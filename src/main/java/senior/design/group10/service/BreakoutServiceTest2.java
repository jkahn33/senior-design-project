...
public class BreakoutServiceTest2 {
	...
	@Test
	public void test() {
		//Requesting a reservation from 10:10 AM to 9:10 AM
		//(this reservation ends before it starts)
		timeNew = Timestamp.valueOf("2007-6-11 10:10:00.0");
